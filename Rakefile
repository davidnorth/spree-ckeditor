...
desc 'Generate documentation for the ckeditor extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'CkeditorExtension'
...
desc 'Test the ckeditor extension.'
...
namespace :test do
  desc 'Functional test the ckeditor extension.'
  ...
  desc 'Unit test the ckeditor extension.'
